...
static void main_window_load(Window *window) {
  ...
  s_uptime_layer = text_layer_create(GRect(0, 95, 144, 14)); // A single text line is 14px high
  ...
  s_bluetooth_layer = text_layer_create(GRect(0, 109, 144, 14));
  ...
  s_battery_layer = text_layer_create(GRect(0, 123, 144, 14));
  ...
  // Create Battery TextLayer
  s_weather_layer = text_layer_create(GRect(0, 137, 144, 28));
